...
* **Transfer Restriction:** Like \$ORROT, these are **locked to the user’s wallet** to prevent "dumping" and external manipulation.
...
* **The Arbitrage/ROI Loop:** Users can use their high-yield \$ORRO or \$ORROS interest to purchase \$ORROT at a tiered discount*:
